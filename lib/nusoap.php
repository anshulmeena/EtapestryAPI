...
class wsdl extends nusoap_base {
	...
	*/
	...
	function serializeType($name, $type, $value, $use='encoded', $encodingStyle=false, $unqualified=false)
	{
      ...
      /////////////////////////////////////////////////////
      // Start eTapestry Edit                            //
      // ----------------------------------------------- //
      // The following code was added to allow $ns and   //
      // $uqType to be derived from an associative array //
      // that has been  mapped to a type of anyType.     //
      // NuSOAP cannot determine the name of the complex //
      // type being used in a situation like this.       //
      /////////////////////////////////////////////////////
      if ($uqType == "anyType" && is_array($value) && array_key_exists("eTapestryObjectName", $value))
      {
        $ns = "etapestryAPI/service";
        $uqType = $value["eTapestryObjectName"];
      }
      /////////////////////////////////////////////////////
      // End eTapestry Edit                              //
      /////////////////////////////////////////////////////
